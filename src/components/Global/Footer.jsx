      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div id="Footer_1" className="space-y-4">
            ...
            <p className="text-gray-300">Your trusted partner in real estate, helping you find your perfect home since 2010.</p>
            <img src={images[0]} alt="Company Logo" className="h-12" />
          </div>
          
          <div id="Footer_2" className="space-y-4">
            <h3 className="text-xl font-bold mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li><Link to="/home" className="text-gray-300 hover:text-white transition duration-300">Home</Link></li>
              <li><Link to="/login" className="text-gray-300 hover:text-white transition duration-300">Login</Link></li>
              <li><Link to="/propertydetails" className="text-gray-300 hover:text-white transition duration-300">Properties</Link></li>
              <li><Link to="/userprofile" className="text-gray-300 hover:text-white transition duration-300">Profile</Link></li>
            </ul>
          </div>
